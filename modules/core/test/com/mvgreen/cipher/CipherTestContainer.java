...
public class CipherTestContainer extends TestContainer {

    public CipherTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/mvgreen/cipher/app.properties",
    ...
    public static class Common extends CipherTestContainer {

        public static final CipherTestContainer.Common INSTANCE = new CipherTestContainer.Common();
